...
base = cv2.imread('.\samples\carettacaretta\carettacaretta_1.jpg')
test1 = cv2.imread('.\samples\eretmochelysimbricata\eretmochelysimbricata_3.jpg')
test2 = cv2.imread('.\samples\dermochelyscoriacea\dermochelyscoriacea_6.jpg')
